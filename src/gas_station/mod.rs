...
mod tests {
    ...
    async fn test_station_reserve_gas() {
        ...
        assert_eq!(station.get_available_coin_count(sponsor1).await, 7);
        ...
        assert_eq!(station.get_available_coin_count(sponsor1).await, 0);
        assert!(station
    ...
    async fn test_e2e_gas_station_flow() {
        ...
        assert_eq!(station.get_available_coin_count(sponsor).await, 0);
        assert!(station
            .reserve_gas(None, 1, Duration::from_secs(10))
            .await
            .is_err());
